		...
		<div class="container-fluid"> 
			<div class="row">
				<div class="col-12">
					...
					$getid = $_GET["id"];
						if($getid){
							$delete = $vt->sil("destek", "where id=?", array($getid));
							if($delete){
								echo '<div class="form-group">
										<div class="alert alert-success">Destek talebi başarıyla silindi. Yönlendiriliyorsunuz.</div>
									</div>';
								header('refresh:2;url=../destek-talepleri'); 
							}else{
								echo '<div class="form-group">
										<div class="alert alert-danger">HATA. Böyle bir Destek talebi yok!</div>
									</div>';
								header('refresh:2;url=../destek-talepleri'); 
							}  
						}else{
