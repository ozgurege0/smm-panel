		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="mdi mdi-bank"></i> Banka Hesabı Sil</h4>  
					<div class="">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="anasayfa">Kullanıcı Panel</a></li>
							<li class="breadcrumb-item active">Banka Hesabı Sil</li>
						</ol>
					</div>                                      
		...
		<div class="container-fluid"> 
			<div class="row">
				<div class="col-12">
					...
					$getid = $_GET["id"];
						if($getid){
							$delete = $vt->sil("banka", "where id=?", array($getid));
							if($delete){
								echo '<div class="form-group">
										<div class="alert alert-success">Banka hesabı başarıyla silindi. Yönlendiriliyorsunuz.</div>
									</div>';
								header('refresh:2;url=../banka-hesaplari'); 
							}else{
								echo '<div class="form-group">
										<div class="alert alert-danger">HATA. Böyle bir banka hesabı yok!</div>
									</div>';
								header('refresh:2;url=../banka-hesaplari'); 
							}  
						}else{
