<?php
$getid = $_GET['id'];
if($getid == 4 || $getid == 3 || $getid == 2 || $getid == 1 || $getid == 0){
if($getid == "3"){
$text = 'Devam Etmekte Olan';
}else if($getid == "2"){
$text = 'İptal Edilen';
}else if($getid == "1"){
$text = 'Kısmi Tamamlanan';
}else if($getid == "0"){
$text = 'Tamamlanan';
}else{
$text = 'Yeni Verilen';
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="mdi mdi-shopping mr-2"></i><?=$text?> Siparişler</h4>  
					<div class="">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="kullanici-panel/anasayfa">Kullanıcı Panel</a></li>
							<li class="breadcrumb-item active"><?=$text?> Siparişler</li>
						</ol>
					</div>                                      
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body new-user order-list">
							<h4 class="header-title mt-0 mb-3"><?=$text?> Siparişler</h4>
							...
							<div class="table-responsive">
								<table class="table table-hover mb-0 ravertan-arama">
									...
									<tbody>
                                        <?php 
										$uyeler = $vt->cek('OBJ_ALL', 'orders', '*', 'where durum=? ORDER BY id DESC', array($getid));
...
<!-- end page-wrapper -->
<?php }else{header('refresh:0;url=../siparisler');} ?>