<?php
$getid = $_GET['id'];
if($getid == 3 || $getid == 2 || $getid == 1){
if($getid == "3"){
$text = 'Ödeme Destek Talepleri';
}else if($getid == "2"){
$text = 'Diğer Destek Talepleri';
}else if($getid == "1"){
$text = 'Sipariş Destek Talepleri';
}
?>
<!-- Top Bar End -->
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="dripicons-ticket"></i> <?=$text?></h4>  
					<div class="">
						<ol class="breadcrumb">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body new-user order-list">
							<h4 class="header-title mt-0 mb-3"><?=$text?></h4>
							...
							<div class="table-responsive">
								<table class="table table-hover mb-0 ravertan-arama">
                                    ...
                                    <tbody>
                                        <?php 
                                        $vericek = $vt->cek('OBJ_ALL', 'destek', '*', 'where onay=? and konu=?', array(1,$getid));
...
<!-- end page-wrapper -->
<?php }else{header('refresh:0;url=../tickets');} ?>
