		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="dripicons-broadcast"></i> Duyurular</h4>  
					<div class="">
						<ol class="breadcrumb">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body new-user order-list">
							<h4 class="header-title mt-0 mb-3">Duyurular</h4>
							<div class="form-group">
								<a href="duyuru-ekle"><button class="btn btn-success btn-block" type="submit">Duyuru Ekle</button></a>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" id="ravertan-input" placeholder="Aradığınız duyuruyu yazın..">
							</div>
							<div class="table-responsive">
								<table class="table table-hover mb-0 ravertan-arama">
                                    ...
                                    <tbody>
                                        <?php 
                                        $vericek = $vt->cek('OBJ_ALL', 'duyurular', '*', '', array());
                                        ...
                                        <tr>
                                            <td><?=$row->id?></td>
                                            <td><?=kisalt($row->baslik,'20')?></td>
                                            <td><?=kisalt($row->aciklama,'20')?></td>
                                            <td><?=$durum?></td>
											<td><?=$row->tarih?></td>
											<td><a class="btn btn-info btn-xs" href="duyuru-duzenle/<?=$row->id?>">Düzenle</a></td>
											<td><a class="btn btn-danger btn-xs" onclick="return confirm('<?=kisalt($row->baslik,'20')?> adlı duyuruyu silmek istediğinize eminmisiniz?');" href="duyuru-sil/<?=$row->id?>">Sil</a></td>
                                        </tr>
                                        <?php } ?>
									</tbody>
								</table> <!--end table-->                                               
