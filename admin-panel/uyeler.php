		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="dripicons-user"></i> Üyeler</h4>  
					<div class="">
						<ol class="breadcrumb">
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body new-user order-list">
							<h4 class="header-title mt-0 mb-3">Üyeler</h4>
							<div class="form-group">
								<input type="text" class="form-control" id="ravertan-input" placeholder="Aradığınız üye'yi yazın..">
							</div>
							<div class="table-responsive">
								<table class="table table-hover mb-0 ravertan-arama">
									...
									<tbody>
										<?php 
										$uyeler = $vt->cek('OBJ_ALL', 'uyeler', '*', '', array());
										...
										if($row->onay == 0){
											...
											$durum = '<span class="badge badge-boxed  badge-soft-danger">Hesabı Engellenmiş</span>';
										}if($row->onay == 3){
											$durum = '<span class="badge badge-boxed  badge-soft-info">Admin</span>';
										}
										?>
                                        <tr>
											<td><?=$row->id?></td>
											...
											<td><?=$row->bakiye?> ₺</td>
											<td><?=$durum?></td>
											<td><a class="btn btn-info btn-xs" href="uye-duzenle/<?=$row->id?>">Düzenle</a></td>
											<td><a class="btn btn-danger btn-xs" onclick="return confirm('<?=$row->username?> adlı üyeyi silmek istediğinize eminmisiniz?');" href="uye-sil/<?=$row->id?>">Sil</a></td>
                                        </tr>
										<?php } ?>
									</tbody>
								</table> <!--end table-->                                               
