		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="dripicons-broadcast"></i> Duyuru Sil</h4>  
					<div class="">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="anasayfa">Kullanıcı Panel</a></li>
							<li class="breadcrumb-item active">Duyuru Sil</li>
						</ol>
					</div>                                      
		...
		<div class="container-fluid"> 
			<div class="row">
				<div class="col-12">
					...
					$getid = $_GET["id"];
						if($getid){
							$delete = $vt->sil("duyurular", "where id=?", array($getid));
							if($delete){
								echo '<div class="form-group">
										<div class="alert alert-success">Duyuru başarıyla silindi. Yönlendiriliyorsunuz.</div>
									</div>';
								header('refresh:2;url=../duyurular'); 
							}else{
								echo '<div class="form-group">
										<div class="alert alert-danger">HATA. Böyle bir duyuru yok!</div>
									</div>';
								header('refresh:2;url=../duyurular'); 
							}  
						}else{
