		...
		<div class="container-fluid"> 
			<div class="row">
				<div class="col-12">
					...
					$getid = $_GET["id"];
						if($getid){
							$delete = $vt->sil("uyeler", "where id=?", array($getid));
							if($delete){
								echo '<div class="form-group">
										<div class="alert alert-success">Üye başarıyla silindi. Yönlendiriliyorsunuz.</div>
									</div>';
								header('refresh:2;url=../uyeler'); 
							}else{
								echo '<div class="form-group">
										<div class="alert alert-danger">HATA. Böyle bir üye yok!</div>
									</div>';
								header('refresh:2;url=../uyeler'); 
							}  
						}else{
