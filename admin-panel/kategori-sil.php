		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="dripicons-folder-open"></i> Kategori Sil</h4>  
					<div class="">
						<ol class="breadcrumb">
		...
		<div class="container-fluid"> 
			<div class="row">
				<div class="col-12">
					...
					$getid = $_GET["id"];
					if($getid){
					$delete = $vt->sil("kategoriler", "where id=?", array($getid));
					if($delete){
					echo '<div class="form-group">
					<div class="alert alert-success">Kategori başarıyla silindi. Yönlendiriliyorsunuz.</div></div>';
					header('refresh:2;url=../kategoriler'); 
					exit;
					}else{
					echo '<div class="form-group">
					<div class="alert alert-danger">HATA. Böyle bir kategori yok!</div></div>';
					header('refresh:2;url=../kategoriler'); 
					exit;
					}  
					}else{
					echo '<div class="form-group">
					<div class="alert alert-warning">Yanlış değer.</div></div>';
					header('refresh:2;url=../kategoriler');   
					} 
					?>
				</div><!--end col-->
