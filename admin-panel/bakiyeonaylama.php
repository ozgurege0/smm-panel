		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="dripicons-card"></i> Ödeme Talebi İptal Et</h4>  
					<div class="">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="anasayfa">Kullanıcı Panel</a></li>
							<li class="breadcrumb-item active">Ödeme Talebi İptal Et</li>
						</ol>
					</div>                                      
				...
				<div class="col-12">
					...
					$getid = $_GET["id"];
						if($getid){
							...
							if($kontrol){
								$guncelle2 = $vt->guncelle('0','odemeler', 'onay,mesaj', 'where id=?', array('2','İptal Edildi', $kontrol['id']));
								if($guncelle2){
									echo '<div class="form-group">
										<div class="alert alert-success">Ödeme talebi başaryırla iptal edildi.!</div>
									</div>';
