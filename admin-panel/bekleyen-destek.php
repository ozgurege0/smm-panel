		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<h4 class="page-title mb-2"><i class="dripicons-ticket"></i> Bekleyen Destek Talepleri</h4>  
					<div class="">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="anasayfa">Kullanıcı Panel</a></li>
							<li class="breadcrumb-item active">Bekleyen Destek Talepleri</li>
						</ol>
					</div>                                      
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body new-user order-list">
							<h4 class="header-title mt-0 mb-3">Bekleyen Destek Talepleri</h4>
							...
							<div class="table-responsive">
								<table class="table table-hover mb-0 ravertan-arama">
                                    ...
                                    <tbody>
                                        <?php 
                                        $vericek = $vt->cek('OBJ_ALL', 'destek', '*', 'where onay=?', array(1));
