...
if($_SESSION){
   header('refresh:0;url='.$ayar['url'].'/kullanici-panel/kullanim-sozlesmesi');
}else{
        ...
        <div class="container nav-container">
            ...
            <div class="collapse navbar-collapse" id="appside_main_menu">
                <ul class="navbar-nav">
                    ...
                    <li class="current-menu-item"><a href="kullanim-sozlesmesi">Kullanım Koşulları</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    <h1 class="page-title">Kullanım Sözleşmesi</h1>
            ...
            <div class="col-md-12">
				<div class="single-post-details-item dark-bg"><!-- blog single content -->
					<div class="entry-content">
						<p><?=nl2br($ayar['kullanim_sozlesmesi'])?></p>
					</div>
				</div> 
            </div>
        </div>
